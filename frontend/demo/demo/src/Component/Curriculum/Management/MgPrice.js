            ...
            <div class="row">
              <div class="col-md-4">
                <div class="plan-card self-led">
                  ...
                  <div  style={{ textAlign: 'center' }}><Link className='Mgbtn btn btn-dark'>3,500/-</Link></div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="plan-card acknowledge-pre">
                  ...
                  <div  style={{ textAlign: 'center' }}><Link className='Mgbtn btn btn-dark'>5,500/-</Link></div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="plan-card advanced-mentor-pre">
                  ...
                  <div  style={{ textAlign: 'center' }}><Link className='Mgbtn btn btn-dark'>7,500/-</Link></div>
                </div>
              </div>
            </div>
          </div>
