...
function CivilPayment() {
  return (
    <div className="CBg7 "><div>
      <h6 className="text-center my-2">Students can choose the plan that best fits their learning preferences and career goals.</h6></div>
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="plan-card self-led">
        ...
        <div  style={{ textAlign: 'center' }}>                  <Link to="/Payment7" className="btn btn-dark">₹ 3,500/-</Link>
</div>
    ...
    <div class="col-md-4">
      <div class="plan-card acknowledge-pre">
        ...
        <div  style={{ textAlign: 'center' }}>                  <Link to="/Payment7" className="btn btn-dark">₹ 5,500/-</Link>
</div>
    ...
    <div class="col-md-4">
      <div class="plan-card advanced-mentor-pre">
        ...
        <div  style={{ textAlign: 'center' }}>                  <Link to="/Payment7" className="btn btn-dark">₹ 7,500/-</Link>
</div>
