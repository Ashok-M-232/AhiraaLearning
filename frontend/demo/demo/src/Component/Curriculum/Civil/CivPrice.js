...
function CivPrice() {
  return (
    <div>
        <div className="civbg5 ">
          <div>
            <h6 className="text-center" style={{color:'Black', fontSize:'25px', paddingBottom:'12px'}}>Students can choose the plan that best fits their learning preferences and career goals.</h6>
          </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="plan-card self-led">
                  ...
                  <div  style={{ textAlign: 'center' }}><Link className='btn btn-dark'>3,500/-</Link></div>
              ...
              <div class="col-md-4">
                <div class="plan-card acknowledge-pre">
                  ...
                  <div  style={{ textAlign: 'center' }}><Link className='btn btn-dark'>5,500/-</Link></div>
              ...
              <div class="col-md-4">
                <div class="plan-card advanced-mentor-pre">
                  ...
                  <div  style={{ textAlign: 'center' }}><Link className='btn btn-dark'>7,500/-</Link></div>
